...
namespace Mango.Framework.EFCore
{
    public static class EFExtended
    {
        ...
        /// <returns></returns>
        public static List<MangoData> ToMangoDataList(this IQueryable<object> source)
        {
            List<MangoData> mangoDatas = new List<MangoData>();
            try
            {
                ...
                {
                    MangoData data = new MangoData();
                    PropertyInfo[] properties = res.GetType().GetProperties();
                    foreach (var property in properties)
                    {
                        object value = property.GetValue(res, null);
